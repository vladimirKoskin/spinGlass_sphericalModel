...
%
colList = [ 'k' 'b' 'r' 'g' 'm' 'y'];
% 5 IC,1M, D=3 , N_tot=10000 Dt = 0.001: 
% 5 IC,1M, D=5 , N_tot=10000 Dt = 0.001: 
% 5 IC,1M, D=10 , N_tot=10000 Dt = 0.001: 18.05 seconds OR 48.05
% 5 IC,1M, D=20 , N_tot=10000 Dt = 0.001: 66.35 seconds
% 5 IC,1M, D=50 , N_tot=10000 Dt = 0.001: 433.78 seconds
% 5 IC,1M, D=50 , N_tot=20000 Dt = 0.001: 847.75 seconds
...
for i = 1:N-1 % Loop to update the N-1 angles 
    ...
    phidot(i) = cot(angls(i,j-1))*E - F + mu*cot(angls(i,j-1)) + H(i)/((x(:,j-1)'*x(:,j-1))*prod(sin(angls(1:i,j-1))));
...
toc
title('Angular dynamics (N=50 R=1) Matrix 1');
